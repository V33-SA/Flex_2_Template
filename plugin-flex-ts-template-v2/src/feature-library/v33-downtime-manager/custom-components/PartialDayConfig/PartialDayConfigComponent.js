...
import '../../flex-hooks/styles/styledTable.css';
  ...
  return (
    <Stack orientation="vertical" spacing="space60">
      <Stack orientation="horizontal" spacing="space60">
        <Label>Jours Partiels :</Label>
        {
                    !isReadOnly &&
        <Button variant="secondary" onClick={addNewPartialday}>
          {' '}
          <PlusIcon decorative={false} title="Ajouter un nouveau jour partiel" /> Ajouter
        </Button>
}
      </Stack>

      {partialdayList.length === 0 && <Paragraph>Aucun jour partiel configuré</Paragraph>}
              ...
              <tr key={partialday.key}>
                ...
                <td>
                  <Input
                    ...
                    placeholder="Nom du jour partiel"
                    readOnly={isReadOnly} 
                  />
                </td>
                <td>
                  <TextArea
                    ...
                    placeholder="Message hors ligne"
                    readOnly={isReadOnly} 
                  />
                </td>
                {
      ...
      <AlertDialog
        heading="Supprimer la ligne"
        isOpen={confirmDeleteDialogIsOpen}
        destructive
        onConfirm={handleConfirmDeletion}
        onConfirmLabel="Supprimer"
        onDismiss={handleCancelDeletion}
        onDismissLabel="Annuler"
      >
